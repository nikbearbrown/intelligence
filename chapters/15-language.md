...
<!-- → [IMAGE: timeline of the language acquisition curriculum from birth to 36 months — proto-conversations at 2–4 months (dyad: infant and caregiver face-to-face), gaze following at 6–9 months, joint attention and declarative pointing at 9–14 months (triad: infant, caregiver, object), first words at 12 months, vocabulary explosion at 18 months, question forms at 18–24 months, recursive grammar at 30–36 months; a second row beneath should show a chimpanzee raised in a language-rich environment, annotated to stop at imperative pointing with no declarative pointing, no questions, and no recursion — student should see that the human sequence is not vocabulary acquisition but a social scaffolding program, and that the chimpanzee's trajectory diverges at the declarative pointing step, not at the word-learning step] -->
