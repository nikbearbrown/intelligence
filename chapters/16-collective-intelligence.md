...
<!-- → [INFOGRAPHIC: timeline showing the three mechanisms in evolutionary order — aggregation (present in Galton's crowd and any population of independent estimators), coordination (present in murmurations, fish schools, bee foraging), cumulative culture (present only in humans with documented ratcheting) — with a vertical axis of "generational improvement" showing flat for aggregation and coordination, logarithmically increasing for cumulative culture; student should see that the ratchet is categorically different from the other two] -->
...
<!-- → [DIAGRAM: four-panel schematic of the swarm decision mechanism — panel 1: scouts departing the cluster toward two candidate sites; panel 2: two dancer populations on the cluster surface with vibrational stop-signal arrows crossing between them; panel 3: one population growing as the other shrinks, with a quorum threshold line; panel 4: swarm lifting off toward the winning site — caption: "quality-weighted positive feedback (panel 1-2) plus cross-inhibition (panel 2-3) plus quorum threshold (panel 3-4) produces convergence to the best site without any node holding the answer in advance"] -->
